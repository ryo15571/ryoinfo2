...
const Kaset = () => {
    return (
        ...
        <img className="h-96 w-96 mx-16 my-12" src="./image/นิสิต.jpg" />
        <img className="h-96 w-96 mx-16 my-12" src="./image/ปี3.jpg" />
        <img className="h-96 w-96 mx-16 my-12" src="./image/ปี4.jpg" />
        <img className="h-96 w-96 mx-16 my-12" src="./image/เรียนจบ.jpg" />
        </div>
        </div>
        </div>
    )
